...
DWORD WINAPI Split(LPVOID num){ // function that ties it all together 
...
DWORD* Sundaram(DWORD size){ // sieve of sundaram finds all the prime numbers up to n, returns that list of numbers
